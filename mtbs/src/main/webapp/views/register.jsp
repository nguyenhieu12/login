    ...
    <div class="modal open js-modal register js-register">
        <div class="modal__container js-modal__container">
            ...
            <div class="modal__goback js-login-btn">
                <a href="<%=request.getContextPath()%>/views/login.jsp"><i class='bx bx-arrow-back'></i></a>
            </div>
                    ...
                    <div class="user-details">
                        <div class="user-details">
                            <div class="input-box">
                                ...
                                <input type="text" placeholder="Enter your username" name="username" required minlength="8">
                            </div>

                            <div class="input-box">
                                <label for="" class="info">Password</label>
                                <input type="password" placeholder="Enter your password" name="password" required minlength="8" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*?[0-9])(?=.*?[!@#$%^&*+`~'=?\|\]\[\(\)\-<>/]).{8,}">
                            </div>
