...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="./assets/img/popcorn.png">
    ...
    <div class="hero-slide">
        <div class="owl-carousel carousel-nav-center" id="hero-carousel">
            ...
            <div class="hero-slide-item">
                <img src="/assets/img/hero/hero1.jpg" alt="">
            ...
            <!-- start slide item -->
            <div class="hero-slide-item">
                <img src="/assets/img/hero/hero6.jpg
                    " alt="">
                <div class="overplay"></div>
                <div class="hero-slide-item-content">
                    <div class="item-content-wrapper">
            ...
            <!-- start slide item -->
            <div class="hero-slide-item">
                <img src="/assets/img/hero/hero7.png" alt="">
                <div class="overplay"></div>
                <div class="hero-slide-item-content">
                    <div class="item-content-wrapper">
                        <div class="item-content-title top-down">
            ...
            <!-- start slide item -->
            <div class="hero-slide-item">
                <img src="/assets/img/hero/hero8.jpg" alt="">
                <div class="overplay"></div>
                <div class="hero-slide-item-content">
                    <div class="item-content-wrapper">
                        <div class="item-content-title top-down">
            ...
            <!-- start slide item -->
            <div class="hero-slide-item">
                <img src="/assets/img/hero/hero9.jpg
                                    " alt="">
                <div class="overplay"></div>
                <div class="hero-slide-item-content">
                    <div class="item-content-wrapper">
