                    ...
                    <div class="user-details">
                        <div class="user-details">
                            ...
                            <div class="input-box">
                                ...
                                <input type="text" placeholder="Enter movie poster url" name="movie_poster_url" required>
                            </div>

                            <div class="input-box">
                                <label for="" class="info">Trailer url</label>
                                <input type="text" placeholder="Enter movie trailer url" name="movie_trailer_url" required>
                            </div>
